    ...
    <section id="photography" className="py-8 md:py-12 relative">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <span className="font-mono text-[#999] text-xs md:text-sm tracking-widest">photography</span>
            </div>
      ...
      >
        {photos.map((n) => (
          <div
            key={n}
            className="flex-shrink-0 w-[240px] md:w-[300px] rounded-lg overflow-hidden bg-[#111] border border-[#1e1e1e] flex flex-col"
            style={{ scrollSnapAlign: "start" }}
          >
            <div className="relative w-full aspect-[3/2] flex items-center justify-center bg-[#0e0e0e]">
              <span className="font-mono text-xs text-[#444] tracking-widest">[ photo {n} ]</span>
            </div>
            <div className="px-3 py-2.5 border-t border-[#1e1e1e]">
              <span className="font-mono text-[11px] text-[#666] tracking-wide">[ caption placeholder ]</span>
            </div>
          </div>
        ))}
      </motion.div>
